 ...
 * и подзаголовок. Что в подзаголовке — решает вызывающий экран: на выборе УПД
 * это «Грузополучатель: …», на списках 2 Этапа — госномер машины.
 * По тапу — переход к форме этапа.
 */
@Composable
fun UpdSummaryCard(
    title: String,
